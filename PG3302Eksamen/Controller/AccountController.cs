        ...
        while (true) {
            ...
            switch (savingsOrCurrentAcc) {
                case "1": {
                    ...
                    SendAccountToDatabase(new SavingsAccountFactory(), personIdentifier, newAccountName, personRep,
                ...
                case "2": {
                    ...
                    SendAccountToDatabase(new CurrentAccountFactory(), personIdentifier, newAccountName, personRep,
                        accountNumberGenerated);
                    break;
                }
            }
